...
export class wy extends Component {
    ...
    render() {
        return (
            ...
            projectDesc2="I was free to choose tech stack for the project and went with HTML5, CSS3/SASS, Bootstrap, Javascript, SWUP, AOS for scroll animations, and Parcel as an application bundler. I added essential SEO meta tags, and also provided tech support to deploy the production site to the client's server. *I do not maintain this site."
