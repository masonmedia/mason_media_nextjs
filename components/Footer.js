            ...
            <footer>
                ...
                <Container fluid className="p-0">
                    <Row className="bg-black p-0">
                        <Col xl={3} md={6} className="align-left-top px-5 pt-5 rainbow-text-2">
                            <div className="display-4 font-weight-bold mb-0">↘</div>
                            <h4 className="font-weight-bold m-0">Mason Media</h4>
                        ...
                        <Col xl={3} md={6} className="align-left-top px-5 pt-5 rainbow-text-2">
                            <div className="display-4 font-weight-bold mb-0">↘</div>
                            <h4 className="font-weight-bold m-0">Work</h4>
                            <div className="h3 m-0">―</div>
                            <ul className="list-unstyled blockquote">
                                ...
                                <Link href="/">
                                    <a><li>N2 Speech Therapy</li></a>
                                </Link>
                            </ul>
                        </Col>
                        <Col xl={3} md={6} className="align-left-top px-5 pt-5 rainbow-text-2">
                            <div className="display-4 font-weight-bold mb-0">↘</div>
                            <h4 className="font-weight-bold m-0">More</h4>
                            <div className="h3 m-0">―</div>
                            <ul className="list-unstyled blockquote">
                        ...
                        <Col xl={3} md={6} className="align-left-top px-5 pt-5 rainbow-text-2">
                            <div className="display-4 font-weight-bold mb-0">↘</div>
                            <h4 className="font-weight-bold m-0">Connect</h4>
                            <div className="h3 m-0">―</div>
                            <ul className="list-unstyled blockquote">
                        ...
                        <Col sm={12} className="align-center rainbow-text-2 pt-4 pb-5">
